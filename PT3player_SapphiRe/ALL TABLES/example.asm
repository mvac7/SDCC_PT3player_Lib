		...
		; --- Version 2: ALL FREQUENCY TABLES ALLOWED       ---
		; --- November 19th, 2008 by SapphiRe               ---
...
INIT:		di					; Disable interrupts
		ld	hl,MUSIC-99			; hl <- initial address of module - 99
...
REPLAYER:	.INCLUDE	"PT3-ROM.ASM"
		...
		; --- INCLUDE MUSIC in ROM code (don't forget to strip first 99 bytes of PT3 module ---
MUSIC:		.INCBIN		"MUSIC.99"
