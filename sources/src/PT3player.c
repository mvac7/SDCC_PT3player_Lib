...
;Clear PT3 state value 
	;xor  A  
	;ld   (#_PT3_state),A
	ld    HL,#_PT3_state
	ld   (HL),#0b10000000

;Init AY (set intern AY) and Clear AY registers
;	call ClearDefAYbuffer
	call _InitAY		;Initialice AY (AY38910BF library) 
...
Input:       - (char) Loop - 0=OFF ; 1=ON  (you can use <switcher> definition)
Output:      -
============================================================================= */
